...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* robotkit service */
    {
        0x000Eu, /* Handle of the robotkit service */ 
        {

            /* led characteristic */
            {
                0x0010u, /* Handle of the led characteristic */ 
            ...
            {
                0x0013u, /* Handle of the ultrasonic characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0014u, /* Handle of the ultrasoniccccd descriptor */ 
            ...
            /* led2 characteristic */
            {
                0x0017u, /* Handle of the led2 characteristic */ 
            ...
            {
                0x001Au, /* Handle of the motor characteristic */ 
            ...
            /* text characteristic */
            {
                0x001Du, /* Handle of the text characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x001Eu, /* Handle of the textcccd descriptor */ 
                    0x001Fu, /* Handle of the Characteristic User Description descriptor */ 
                }, 
            },

            /* IR_pin1 characteristic */
            {
                0x0021u, /* Handle of the IR_pin1 characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0022u, /* Handle of the ir1cccd descriptor */ 
                    0x0023u, /* Handle of the Characteristic User Description descriptor */ 
                }, 
            },

            /* IR_pin2 characteristic */
            {
                0x0025u, /* Handle of the IR_pin2 characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0026u, /* Handle of the ir2cccd descriptor */ 
