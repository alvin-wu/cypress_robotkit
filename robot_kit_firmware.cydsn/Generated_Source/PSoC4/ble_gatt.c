    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x87u] = {
    /* Device Name */
    ...
    /* Characteristic User Description */
    (uint8)'u', (uint8)'l', (uint8)'t', (uint8)'r', (uint8)'a', (uint8)'s', (uint8)'o', (uint8)'n', (uint8)'i', (uint8)'c',
(uint8)' ', (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t', (uint8)'1', (uint8)'6', 

    /* led2 */
    0x00u, 

    /* Characteristic User Description */
    (uint8)'l', (uint8)'e', (uint8)'d', (uint8)'2', (uint8)' ', (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t', (uint8)'8', 

    /* motor */
    0x00u, 0x00u, 

    /* Characteristic User Description */
    (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t', (uint8)'1', (uint8)'6', (uint8)' ', (uint8)'m', (uint8)'o', (uint8)'t',
(uint8)'o', (uint8)'r', (uint8)' ', (uint8)'c', (uint8)'o', (uint8)'n', (uint8)'t', (uint8)'r', (uint8)'o', (uint8)'l', 
...
0x00u, 0x00u, 0x00u, 
    ...
    /* Characteristic User Description */
    (uint8)'t', (uint8)'e', (uint8)'x', (uint8)'t', (uint8)' ', (uint8)'b', (uint8)'u', (uint8)'f', (uint8)'f', (uint8)'e',
(uint8)'r', (uint8)' ', (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t', (uint8)'8', 

    /* IR_pin1 */
    0x00u, 0x00u, 

    /* Characteristic User Description */
    (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t', (uint8)'8', (uint8)'t', 
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* robotkit UUID */
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* ultrasonic UUID */
    { 0x0002u, (void *)&cyBle_attValues[30] }, /* ultrasonic */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* ultrasoniccccd */
    { 0x0011u, (void *)&cyBle_attValues[32] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* led2 UUID */
    { 0x0001u, (void *)&cyBle_attValues[49] }, /* led2 */
    { 0x000Au, (void *)&cyBle_attValues[50] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[4] }, /* motor UUID */
    { 0x0002u, (void *)&cyBle_attValues[60] }, /* motor */
    { 0x0014u, (void *)&cyBle_attValues[62] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[5] }, /* text UUID */
    { 0x0014u, (void *)&cyBle_attValues[82] }, /* text */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[4] }, /* textcccd */
    { 0x0011u, (void *)&cyBle_attValues[102] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[6] }, /* IR_pin1 UUID */
    { 0x0002u, (void *)&cyBle_attValues[119] }, /* IR_pin1 */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[6] }, /* ir1cccd */
    { 0x0006u, (void *)&cyBle_attValues[121] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[7] }, /* IR_pin2 UUID */
    { 0x0002u, (void *)&cyBle_attValues[127] }, /* IR_pin2 */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[8] }, /* ir2cccd */
    { 0x0006u, (void *)&cyBle_attValues[129] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x27u] = {
    ...
    { 0x0003u, 0x2A00u /* Device Name                         */, 0x00000201u /* rd     */, 0x0003u, {{0x0005u, (void *)&cyBle_attValuesLen[0]}} },
    ...
    { 0x000Eu, 0x2800u /* Primary service                     */, 0x00080001u /*        */, 0x0027u, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Fu, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x0011u, {{0x0010u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0010u, 0x0000u /* led                                 */, 0x00090A04u /* rd,wr  */, 0x0011u, {{0x0001u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0011u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x0011u, {{0x0009u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0012u, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf */, 0x0015u, {{0x0010u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0013u, 0x0000u /* ultrasonic                          */, 0x00091201u /* rd,ntf */, 0x0015u, {{0x0002u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0014u, 0x2902u /* ultrasoniccccd                      */, 0x00010A04u /* rd,wr  */, 0x0014u, {{0x0002u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x0015u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x0015u, {{0x0011u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0016u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x0018u, {{0x0010u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0017u, 0x0000u /* led2                                */, 0x00090A04u /* rd,wr  */, 0x0018u, {{0x0001u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0018u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x0018u, {{0x000Au, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0019u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x001Bu, {{0x0010u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x001Au, 0x0000u /* motor                               */, 0x00090A04u /* rd,wr  */, 0x001Bu, {{0x0002u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x001Bu, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x001Bu, {{0x0014u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x001Cu, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf */, 0x001Fu, {{0x0010u, (void *)&cyBle_attValuesLen[20]}} },
    { 0x001Du, 0x0000u /* text                                */, 0x00091201u /* rd,ntf */, 0x001Fu, {{0x0014u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x001Eu, 0x2902u /* textcccd                            */, 0x00010A04u /* rd,wr  */, 0x001Eu, {{0x0002u, (void *)&cyBle_attValuesLen[22]}} },
    { 0x001Fu, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x001Fu, {{0x0011u, (void *)&cyBle_attValuesLen[23]}} },
    { 0x0020u, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf */, 0x0023u, {{0x0010u, (void *)&cyBle_attValuesLen[24]}} },
    { 0x0021u, 0x0000u /* IR_pin1                             */, 0x00091201u /* rd,ntf */, 0x0023u, {{0x0002u, (void *)&cyBle_attValuesLen[25]}} },
    { 0x0022u, 0x2902u /* ir1cccd                             */, 0x00010A04u /* rd,wr  */, 0x0022u, {{0x0002u, (void *)&cyBle_attValuesLen[26]}} },
    { 0x0023u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x0023u, {{0x0006u, (void *)&cyBle_attValuesLen[27]}} },
    { 0x0024u, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf */, 0x0027u, {{0x0010u, (void *)&cyBle_attValuesLen[28]}} },
    { 0x0025u, 0x0000u /* IR_pin2                             */, 0x00091201u /* rd,ntf */, 0x0027u, {{0x0002u, (void *)&cyBle_attValuesLen[29]}} },
    { 0x0026u, 0x2902u /* ir2cccd                             */, 0x00010A04u /* rd,wr  */, 0x0026u, {{0x0002u, (void *)&cyBle_attValuesLen[30]}} },
    { 0x0027u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd     */, 0x0027u, {{0x0006u, (void *)&cyBle_attValuesLen[31]}} },
};
